    ...
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            using (var httpsServer = new WebServer(443, HttpProtocol.Https, new Type[] { typeof(HomeController) }))
            {
                ...
                var receiver = new ReceiverLink(session, "Incoming", "q1");
        ...
        private static void onMessage(IReceiverLink receiver, Message message)
        {
            ...
            {
                var bodyBytes = (byte[])message.Body;
            ...
            Debug.WriteLine($"{DateTime.UtcNow} Received message: '{body}'");
